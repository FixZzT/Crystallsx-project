...
const getPlaceholder = (index: number) => placeholderImages[index % placeholderImages.length];

const getProductImages = (brand: string, category: string, product: string, extension: string = 'jpg') => {
...
const imageMap: Record<string, string[]> = {
  'Balenciaga x Adidas Backpack': getProductImages('Balenciaga', 'Backpack', 'Balenciaga x Adidas Backpack'),
  'Adidas Sleeves Zip Up': getProductImages('Balenciaga', 'Hoodies', 'Adidas Sleeves Zip Up'),
  'Logo Recto Grande': getProductImages('Balenciaga', 'Hoodies', 'Logo recto grande'),
  ...
  'Chrome Leather Black': getProductImages('Converse', 'Shoes', 'Chrome Leather Black'),
  'Futures': [
  ...
  'Gimp Zip Up Normal': ['/Rick Owens/Hoodies/Gimp Zip Up Normal/1.png', '/Rick Owens/Hoodies/Gimp Zip Up Normal/2.jpeg'],
  'Mountain Zip Up': ['/Rick Owens/Hoodies/Mountain Zip Up/1.jpeg', '/Rick Owens/Hoodies/Mountain Zip Up/2.jpg', '/Rick Owens/Hoodies/Mountain Zip Up/3.jpg', '/Rick Owens/Hoodies/Mountain Zip Up/4.jpg', '/Rick Owens/Hoodies/Mountain Zip Up/5.jpeg'],
  'Gimp': ['/Rick Owens/Jacket/Gimp/1.jpg', '/Rick Owens/Jacket/Gimp/2.jpg', '/Rick Owens/Jacket/Gimp/3.jpg'],
  'Bela Neutro White': ['/Rick Owens/Pants/Bela Neutro White/1.jpg', '/Rick Owens/Pants/Bela Neutro White/2.jpg'],
  'Bolan Banana Cut': ['/Rick Owens/Pants/Bolan Banana Cut/1.jpg', '/Rick Owens/Pants/Bolan Banana Cut/2.jpg'],
  'Porterville Musculosa': ['/Rick Owens/Shirts/Porterville Musculosa/1.jpg', '/Rick Owens/Shirts/Porterville Musculosa/2.jpg'],
  'Army Mega Tractor Boots': ['/Rick Owens/Shoes/Army Mega Tractor Boots/1.jpg', '/Rick Owens/Shoes/Army Mega Tractor Boots/2.jpg'],
  'Converse': ['/Rick Owens/Shoes/Converse/1.jpg', '/Rick Owens/Shoes/Converse/2.jpg'],
  'Big Back Logo': getProductImages('Supreme', 'Hoodie', 'Big back logo', 'jpeg'),
  'Leopard Thermal': ['/Supreme/Hoodie/Leopard thermal/1.jpg', '/Supreme/Hoodie/Leopard thermal/2.jpg'],
};
...
export const catalogData: Brand[] = [
  {
    ...
    categories: [
      ...
      { name: "Hoodies", products: ["Adidas Sleeves Zip Up", "Logo Recto Grande"] },
  ...
  },
  {
    ...
    categories: [
      { name: "Shoes", products: ["Futures", "Gats"] }
    ].map(cat => ({
      name: cat.name,
      products: cat.products.slice(0, 2).map((p, i) => ({
...
export const allProducts = catalogData.flatMap(b => b.categories.flatMap(c => c.products));
